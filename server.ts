...
async function startServer() {
  ...
  let events = [
    {
      id: 'e0',
      title: 'LIVE: Urban Mobility Summit 2026',
      category: 'technical',
      date: 'Today',
      time: 'Happening Now',
      location: 'Vigyan Bhawan, New Delhi',
      description: 'A prestigious gathering of urban planners, AI researchers, and policy makers discussing Delhi\'s 2030 transit vision.',
      ...
      tags: ['Live', 'Transport', 'Sustainability'],
      isFree: true,
      isLive: true
    },
    {
      id: 'e1',
      title: 'Delhi Smart City Hackathon',
      category: 'hackathon',
      date: 'May 15, 2026',
      time: '09:00 AM',
      location: 'IIT Delhi, Hauz Khas',
      description: 'Build AI-driven solutions for waste management, water conservation, and traffic optimization. Win ₹10 Lakhs in grants!',
      organizer: 'Digital India & IIT Delhi',
      image: 'https://images.unsplash.com/photo-1515162816999-a0c47dc192f7?auto=format&fit=crop&w=1200&q=80',
      tags: ['AI', 'GovTech', 'Innovation'],
      isFree: true,
      registrationUrl: 'https://iitd.ac.in/smart-city-hack'
    },
    {
      id: 'e2',
      title: 'Dilli Haat Spring Cultural Fest',
      category: 'cultural',
      date: 'May 05, 2026',
      time: '04:00 PM',
      location: 'Dilli Haat, INA',
      description: 'Celebrate the vibrancy of Indian folk traditions with live performances, authentic street food, and artisan workshops.',
      organizer: 'Delhi Tourism',
      image: 'https://images.unsplash.com/photo-1582560475093-ba66accbc424?auto=format&fit=crop&w=800&q=80',
      tags: ['Culture', 'Crafts', 'Food'],
      isFree: false
    },
    {
      id: 'e3',
      ...
      description: 'Join 5,000+ volunteers on World Environment Day to restore the lifeline of Delhi. Community training provided.',
      ...
      tags: ['Environment', 'EcoFriendly', 'Volunteering'],
      isFree: true
    },
    {
      id: 'e4',
      title: 'Connaught Place Art Festival',
      category: 'cultural',
      date: 'May 20, 2026',
      time: '11:00 AM',
      location: 'Inner Circle, CP',
      description: 'Transforming the heart of the city into a canvas. Open-air galleries, interactive installations, and live painting.',
      organizer: 'Delhi Art Society',
      image: 'https://images.unsplash.com/photo-1514373941175-0a141072bbc8?auto=format&fit=crop&w=800&q=80',
      tags: ['Art', 'Photography', 'CityLife'],
      isFree: true
    },
    {
      id: 'e5',
      ...
      description: 'Over 200 films from 50 countries. Masterclasses with world-renowned directors and world premieres.',
      organizer: 'DIFF Foundation',
      image: 'https://images.unsplash.com/photo-1485846234645-a62644f84728?auto=format&fit=crop&w=800&q=80',
      tags: ['Cinema', 'International', 'Workshops'],
      isFree: false
    },
    {
      id: 'e6',
      ...
      description: 'Exploring the latest in solar tech, electric mobility, and green hydrogen solutions for urban centers.',
      organizer: 'Ministry of New & Renewable Energy',
      image: 'https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?auto=format&fit=crop&w=800&q=80',
      tags: ['Renewables', 'Tech', 'CleanEnergy'],
      isFree: true
    },
    {
      id: 'e7',
      title: 'Tech-Delhi Meetup: Generative AI',
      category: 'technical',
      date: 'May 12, 2026',
      time: '06:30 PM',
      location: 'Cyber Hub, Gurgaon',
      description: 'Deep dive into LLMs and their applications in governance and local language support.',
